...
export default function Footer() {
  return (
    <footer className="landing-section bg-black border-t border-white/10" style={{ backgroundColor: '#000000' }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-white/70 mb-6 max-w-sm">
                Revolutionizing financial intelligence with AI-powered insights and enterprise-grade security.
              </p>
        ...
        >
          <p className="text-white/50 text-sm">
            © 2025 UniFinance. All rights reserved.
          </p>
