...
// Ícone de Gráfico de Barras (substitui 📊)
...
// Ícone de Pizza/Gráfico Circular (substitui 🥧)
export function PieChartIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// Ícone de Dinheiro Voando (substitui 💸)
export function MoneyOffIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M17 9V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2m2-4h10a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2v-2" />
      <line x1="2" x2="22" y1="2" y2="22" />
    </svg>
  )
}

// Ícone de Bola de Cristal (substitui 🔮)
export function CrystalBallIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M21.17 8a3 3 0 0 0-5.25-2.14" />
      <path d="M15.5 6.5a3 3 0 0 0-6 0" />
      <path d="M2.83 16a3 3 0 0 0 5.25 2.14" />
      <path d="M8.5 17.5a3 3 0 0 0 6 0" />
    </svg>
  )
}
