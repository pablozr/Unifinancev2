    ...
    <div className="group bg-white/[0.02] backdrop-blur-xl border border-white/[0.08] rounded-2xl p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="h-64 sm:h-80 relative overflow-x-auto">
          <div className="min-w-full sm:min-w-0" style={{ minWidth: data.length * 80 + 100 }}>
            <div className="relative pl-12 sm:pl-20 pr-4">
              {/* Grid lines de fundo */}
              ...
              <div className="flex items-end justify-between h-48 sm:h-64 space-x-2 sm:space-x-3 relative z-10">
                {data.map((item, index) => {
                  // Altura base do gráfico ajustada responsivamente
                  const chartHeight = 160 // altura base para mobile e será aumentada com CSS
                  ...
                  return (
                    <motion.div
                      key={index}
                      className="flex-1 flex flex-col items-center relative group min-w-[60px] sm:min-w-[80px]"
                    ...
                    >
                      ...
                      {hoveredIndex === index && (
                        <motion.div
                          ...
                          className="absolute bottom-full mb-2 sm:mb-4 bg-white/[0.05] backdrop-blur-sm border border-white/[0.08] rounded-lg p-3 sm:p-4 text-xs sm:text-sm text-white z-20 min-w-36 sm:min-w-48"
                        >
                          <div className="font-medium mb-2 sm:mb-3 text-center border-b border-white/[0.08] pb-1 sm:pb-2">
                            {item.month}
                          </div>
                          <div className="space-y-1 sm:space-y-2">
                            ...
                            <div className="border-t border-white/[0.08] pt-1 sm:pt-2 flex justify-between font-medium">
                      ...
                      {/* Barras melhoradas */}
                      <div className="w-full flex space-x-1 sm:space-x-2 items-end h-full justify-center max-w-12 sm:max-w-16">
                        {/* Barra de Receitas */}
                        <motion.div
